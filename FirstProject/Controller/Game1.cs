...
namespace FirstProject.Controller
{
	...
	public class Game1 : Microsoft.Xna.Framework.Game
	{
		...
		protected override void LoadContent()
		{
			...
			projectile2Texture = Content.Load<Texture2D>("Texture/laser2");
			projectile3Texture = Content.Load<Texture2D>("Texture/laser3");
		...
		private void AddProjectile2(Vector2 position)
		{
			...
			projectile2.Initialize(GraphicsDevice.Viewport, projectile2Texture, position);
		...
		{
			Projectile3 projectile3 = new Projectile3();
			projectile3.Initialize(GraphicsDevice.Viewport, projectile3Texture, position);
			projectiles3.Add(projectile3);
		}
